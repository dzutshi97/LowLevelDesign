package com.Uber.CustomScheduler;
...
public class CustomSchedulerService {
    ...
    private final PriorityQueue<ScheduledTask> taskQueue; //use PriorityBlockingQueue
    private final Lock lock = new ReentrantLock(); //why do we use a shared lock and not new lock for each  method?
    ...
    public CustomSchedulerService(int workerThreadSize) {
        ...
        workerExecutor = (ThreadPoolExecutor) Executors.newFixedThreadPool(workerThreadSize); //do not use a ready made thread pool executor. prefe using this only for testing. use for loop for interviews?
    }
    ...
    public void schedule(Runnable command, long delay, TimeUnit unit) {
        ...
        try{
            ...
            taskQueue.add(task);
            newTaskAdded.signalAll(); //whynot notifyAll?
        }catch (Exception e){
